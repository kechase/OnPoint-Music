...
my_data <- read.csv("~/Documents/workspace/OnPoint-Music/Data/raw/2025-03-23_katiesundaysunday.csv") 
...
input_file_path <- "~/Documents/workspace/OnPoint-Music/Data/raw/2025-03-23_katiesundaysunday.csv"
input_filename <- basename(input_file_path)
input_name <- tools::file_path_sans_ext(input_filename)

# Create output directory named after the input file
output_dir <- file.path("~/Documents/workspace/OnPoint-Music/Data/analysis_output", input_name)
